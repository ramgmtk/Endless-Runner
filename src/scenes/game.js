class Game extends Phaser.Scene {
    ...
    restartGame() {
        ...
        this.add.tileSprite(centerX , centerY - 34 , 348 , 50 , 'gameOver').setOrigin(.5).setAlpha(this.alphaValue);
        this.add.tileSprite(centerX, centerY + 30, 469 , 45 , 'tryAgain').setOrigin(.5).setAlpha(this.alphaValue);
        this.add.tileSprite(0, uiSizeY, 1080, 720, 'dio').setOrigin(0).setAlpha(this.alphaValue/25).setDepth(1);
    }
}
